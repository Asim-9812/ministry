...
class CreateMedReminder extends ConsumerStatefulWidget {
  const CreateMedReminder({super.key});

  @override
  ConsumerState<CreateMedReminder> createState() => _CreateMedReminderState();
}

class _CreateMedReminderState extends ConsumerState<CreateMedReminder> {

  Meal? selectedMeal = Meal(mealId: 1, mealTime: 'Before a meal');
  MedicineRoute? selectedRoute;
  MedicineUnit? selectedUnit;
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        // appBar: AppBarWithBorder(text: 'Set Reminder',backButton: true,),
          appBar: CommonBar(text: 'Set Reminder', backButton: true, context: context),
        body: Padding(
              ...
              child: Column(
                ...
                children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      width: 10,
                                      decoration: BoxDecoration(
                                        color: selectedMeal?.mealId == 1? MyColors.primary : MyColors.grey,
                                        borderRadius: BorderRadius.circular(10),
                                        border: Border.all(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      width: 10,
                                      decoration: BoxDecoration(
                                          color: selectedMeal?.mealId == 2? MyColors.primary : MyColors.grey,
                                          borderRadius: BorderRadius.circular(10),
                                          border: Border.all(
                                              color: MyColors.black
                                          )
                  ...
                  TextFormField(
                    ...
                    onTap: (){
                      if(selectedFrequency == null){
                        Toaster.error('Please select a frequency first');
                      }
                      else{
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          ...
                          onTap: (){
                            if(totalDays == null){
                              Toaster.error('Please enter a Medication duration first');
                            }
                            else if(selectedTime == null){
                              Toaster.error('Please schedule a time first');
                            }
                            else{
                              if(dateList.isNotEmpty){
                                dateList.clear();
                  ...
                  ListTile(
                    ...
                    tileColor: image != null ? MyColors.white:  MyColors.lightGrey,
  ...
  void _confirmDialog() async {
    ...
    final medNotes = _noteController.text.isNotEmpty? '${_noteController.text}' : null;
  ...
  void _setDateTime() async{
    ...
    DateTime tempDates2 = tempStartDate;

    // for start date and time
    for(int j = 1; j < repeat;j++){
      tempDates2 = tempDates2.add(Duration(hours: interval));
      tempDateList.add(tempDates2);
    }
  ...
  void _setReminder() async {
    ...
    Future.delayed(Duration(seconds: 2),(){
      ref.read(medicineReminderNotifier.notifier).addReminder(medicineModel: medicineModel, context: context).then((value) {
